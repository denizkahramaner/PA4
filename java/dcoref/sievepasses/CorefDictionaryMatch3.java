...
public class CorefDictionaryMatch3 extends DeterministicCorefSieve {
  public CorefDictionaryMatch3(){
    super();
    ...
    flags.USE_COREF_DICT_COL3 = true;
  }
  public CorefDictionaryMatch3(String args) {
    this();
    flags.set(args);
  }
}
