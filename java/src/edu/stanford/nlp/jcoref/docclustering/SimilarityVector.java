...
public class SimilarityVector implements Serializable {
  ...
  public static SimilarityVector get1stOrderSimilarityVector(List<CoreLabel> words, Dictionaries dict) {
  ...
  public static SimilarityVector get1stOrderTfIdfSentenceVector(List<CoreLabel> words, Dictionaries dict){
    SimilarityVector sv = get1stOrderSimilarityVector(words, dict);
    TfIdf.applyTfIdf(sv, dict.tfIdf);
    return sv;
  }

  public static SimilarityVector get2ndOrderSimilarityVector(List<CoreLabel> words, Dictionaries dict){
  ...
  public static SimilarityVector get2ndOrderTfIdfSentenceVector(List<CoreLabel> words, Dictionaries dict){
