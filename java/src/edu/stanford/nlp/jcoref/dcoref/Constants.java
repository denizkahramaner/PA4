...
public class Constants {
  ...
  /** if true, mention boundary should be correct to be a twin mention
   *  if false, mention is twin if there is a gold mention with same headword */
  public static boolean STRICT_MENTION_BOUNDARY = false;
  ...
  public static final boolean USE_GOLD_NE = true;    //MARTA: false for coref-dict

  /** if false, use Stanford parse to parse */
  public static final boolean USE_GOLD_PARSES = true;   //MARTA: false for coref-dict

  /** if false, use Stanford tagger to tag */
  public static final boolean USE_GOLD_POS = true;    //MARTA: false for coref-dict

  /** if false, use mention prediction */
  public static final boolean USE_GOLD_MENTIONS = false;    //MARTA: true for coref-dict
  ...
  public static final boolean USE_DISCOURSE_SALIENCE = false;
  ...
  public static final boolean REMOVE_SINGLETONS = true;   //MARTA: false for coref-dict

  /** if true, read *auto_conll, if false, read *gold_conll */
  public static final boolean USE_CONLL_AUTO = false;   //MARTA: true for coref-dict
  ...
  public static final String SCHEMAS_PROP = "jcoref.schema";
  ...
  public static final String HYPONYM_LIST = "dcoref.hyponym.list";
  public static final String COREF_DICT = "dcoref.dict";
  public static final String COREF_DICT_NPMI = "dcoref.dict.npmi";
  public static final String CONTEXT_SIGNATURES = "dcoref.sigs";
  public static final String JCB_PROP = "do.jcoref";
  ...
  public static void printConstants(Logger logger) {
    ...
    if (Constants.STRICT_MENTION_BOUNDARY) logger.info("STRICT_MENTION_BOUNDARY on");
    else logger.info("STRICT_MENTION_BOUNDARY off");
    logger.info("=================================================================");
  }
}
